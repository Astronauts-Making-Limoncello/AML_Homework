...
def test(ckpt_path, final_epoch_print):
    ...
    print(f"{final_epoch_print} | test loss (avg of all actions): [bold][#9400D3]{np.round((running_loss/n).item(),1)}[/#9400D3][/b]")
